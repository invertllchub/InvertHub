...
const SearchIcon = ({ isDark }: { isDark: boolean }) => {
  ...
  const { data } = useGetProjectsWithPagination(1, 4, debouncedSearchValue);
  ...
  return (
    <>
      ...
      >
        <div
          className={`w-10/12 h-10/12 bg-white rounded-lg shadow-lg transition-transform duration-500 transform 
